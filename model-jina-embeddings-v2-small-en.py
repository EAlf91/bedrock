...
embedding_model_cpu = TextEmbedding(
    model_name="jinaai/jina-embeddings-v2-small-en", providers=["CPUExecutionProvider"]
)

embedding_model_gpu = TextEmbedding(
    model_name="jinaai/jina-embeddings-v2-small-en", providers=["CUDAExecutionProvider"]
)
